...
2. **安装仓库中的脚本**：
   * **方式一（推荐）**：直接点击上方表格中的 [点击一键安装](https://raw.githubusercontent.com/guodonglu/tampermonkey-scripts/main/huya-ad-blocker/huya-ad-blocker.user.js) 链接，扩展会自动捕获并提示安装。
...
│
├── huya-ad-blocker/                   # 脚本1：虎牙全方位广告屏蔽器
│   ├── README.md                      # 脚本详细配置说明与图文指引
│   └── huya-ad-blocker.user.js        # 脚本安装源码 (.user.js)
│
└── huya-streamer-blocker/             # 脚本2：虎牙主播屏蔽器
    ├── README.md                      # 脚本详细配置说明与图文指引
